      ...
      */}
      ...
      <div className={`intro__scene ${active('scene1') ? 'intro__scene--active' : ''}`}>
        <svg viewBox="0 0 800 400" className="intro__scene-svg" aria-hidden="true">
          ...
          <circle cx="400" cy="200" r="30"  fill="none" stroke="#967e76" strokeWidth="1" className="intro__ring intro__ring--1" />
          <circle cx="400" cy="200" r="80"  fill="none" stroke="#967e76" strokeWidth="1" className="intro__ring intro__ring--2" />
          <circle cx="400" cy="200" r="140" fill="none" stroke="#967e76" strokeWidth="1" className="intro__ring intro__ring--3" />
          ...
          <line x1="260" y1="60" x2="400" y2="200" stroke="#d7c0ae" strokeWidth="1" strokeDasharray="3 5" opacity="0.5" className="intro__lock-line intro__lock-line--1" />
          <line x1="540" y1="60" x2="400" y2="200" stroke="#d7c0ae" strokeWidth="1" strokeDasharray="3 5" opacity="0.5" className="intro__lock-line intro__lock-line--2" />

          {/* Small hollow circles at the top of each lock-line — target markers */}
          <circle cx="260" cy="60" r="4" fill="none" stroke="#eee3cb" strokeWidth="1.5" opacity="0.7" className="intro__lock-dot" />
          <circle cx="540" cy="60" r="4" fill="none" stroke="#eee3cb" strokeWidth="1.5" opacity="0.7" className="intro__lock-dot" />
        </svg>
      </div>
      ...
      <div className={`intro__scene ${active('scene2') ? 'intro__scene--active' : ''}`}>
        <svg viewBox="0 0 800 400" className="intro__scene-svg" aria-hidden="true">
          ...
          <g className="intro__candle intro__candle--1">
            ...
            <rect x="193" y="130" width="54" height="140" fill="#18120e" stroke="#967e76" strokeWidth="1.5" />
          </g>
          ...
          <g className="intro__candle intro__candle--2">
            ...
            <rect x="343" y="165" width="54" height="100" fill="#18120e" stroke="#967e76" strokeWidth="1.5" />
          </g>
          ...
          <g className="intro__candle intro__candle--3">
            ...
            <rect x="493" y="100" width="54" height="185" fill="#d7c0ae" stroke="#eee3cb" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
      ...
      <div className={`intro__scene ${active('scene3') ? 'intro__scene--active' : ''}`}>
        <svg viewBox="0 0 800 400" className="intro__scene-svg" aria-hidden="true">
          ...
          <line x1="450" y1="0" x2="450" y2="400" stroke="#eee3cb" strokeWidth="1" strokeDasharray="4 6" opacity="0.5" />
        </svg>
      </div>
